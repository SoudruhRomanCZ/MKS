...
- name: BOARD_InitPeripherals
  UUID: 8bd2f9d3-3c14-41b6-a7c8-ca0252b3f10c
...
/* Single callback functions definition */
ctimer_callback_t CTIMER2_callback[] = {PWM_IRQ};
...
static void CTIMER2_init(void) {
  ...
  CTIMER_SetupPwmPeriod(CTIMER2_PERIPHERAL, CTIMER2_PWM_PERIOD_CH, CTIMER2_PWM_0_CHANNEL, CTIMER2_PWM_PERIOD, CTIMER2_PWM_0_DUTY, true);
