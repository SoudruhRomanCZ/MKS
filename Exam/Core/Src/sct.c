...
/*
 static const uint32_t reg_values[3][10]={
		{
		//PCDE--------GFAB @ DIS1
		0b0000000000000010 << 16, //only A in DIS1
		0b0100000000000010 << 16, //A and C in DIS1
		},
		{
		//----PCDEGFAB---- @ DIS2
		0b0000000010000000 << 0, //only G in DIS2
		0b0000010000100000 << 0, //A and C in DIS2
		},
		{
		//PCDE--------GFAB @ DIS3
		0b0100000000000000 << 0, //only C in DIS3
		0b0100000000000010 << 0, //A and C in DIS3
		},
};
 */
